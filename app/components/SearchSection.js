...
const SearchSection = () => {
    const { SearchSongs, setclosemenu, closemenu } = useAppContext()
    ...
    return (
        <>
            ...
            >
                <div className="absolute right-4 top-4 cursor-pointer shadow-2xl rounded-full bg-red-400 p-2 text-white"
